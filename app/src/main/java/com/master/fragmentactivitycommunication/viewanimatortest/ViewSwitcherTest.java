package com.master.fragmentactivitycommunication.viewanimatortest;
...
public class ViewSwitcherTest extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.view_switcher_test_main);
		...
		switcher.setFactory(new ViewSwitcher.ViewFactory()
		{
			...
			public View makeView()
			{
				...
				return inflater.inflate(R.layout.view_switcher_test_slidelistview, null);
			}
		});
		// 页面加载时先显示第一屏
		next(null);
	...
	private BaseAdapter adapter = new BaseAdapter()
	{
				...
				, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null)
			{
				...
				view = inflater.inflate(R.layout.view_switcher_test_labelicon, null);
			}
