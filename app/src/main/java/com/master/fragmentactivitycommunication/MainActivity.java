...
import com.master.fragmentactivitycommunication.adapterviewtest.AdapterViewFlipperTest;
...
import com.master.fragmentactivitycommunication.sqlitePractice.InsertData;
import com.master.fragmentactivitycommunication.viewanimatortest.ViewSwitcherTest;
...
public class MainActivity extends LauncherActivity {
    ...
    private String[] names={"PreferenceActivityTest","ExpandableListActivityTest",
            ...
            ,"AdapterViewFlipperTest","StackViewTest","ViewSwitcherTest","InsertData"};
    ...
    Class<?>[] aClass={PreferenceActivityTest.class,ExpandableListActivityTest.class, ActivityTest.class,
            ...
            , ViewSwitcherTest.class, InsertData.class};
